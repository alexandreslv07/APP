...
def build_sidebar():
    st.image("imagem/logo-250-100-transparente.png")
    ...
    start_date = st.date_input("De", format="DD/MM/YYYY", value=datetime(2023,5,2))
...
def build_main(tickers, prices):
    ...
    for t in prices.columns:
        ...
        if t == "portfolio":
            colA.image("imagem/pie-chart-dollar-svgrepo-com.svg")
        elif t == "IBOV":
            colA.image("imagem/pie-chart-svgrepo-com.svg")
        else:
